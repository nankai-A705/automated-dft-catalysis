...
def get_random_hcp_alloy(num_structure, atoms, host,  **kwargs):
    """
...
a = get_random_hcp_alloy(1, atoms, 'Cu', Sn=0.166, Cu=0.166, Mn=0.166,Mo=0.166,Fe=0.166, Co=0.17) # run with this command
